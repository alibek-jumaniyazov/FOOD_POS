        ...
        >
          ...
          <div className="w-full flex justify-between items-center gap-6">
            <button
              onClick={() => closeEditModal()}
              type="button"
              className="w-full !h-[48px] flex justify-center items-center !p-3.5 text-[#EA7C69] bg-transparent border border-[#EA7C69] rounded-lg cursor-pointer text-[14px] font-[600] hover:bg-[#ea7c698e] transition-all duration-300 active:scale-[80%]"
            >
              Cancel
            </button>
